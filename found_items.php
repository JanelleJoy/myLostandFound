...
$sql = "SELECT * FROM admin_post WHERE type = 'found'";
$params = [];
$types = '';
...
<body>
  <div class="topnav">
    <div>
      ...
      <a href="found_items.php" style="background-color:#575757; border-radius:5px;">Found Items</a>
